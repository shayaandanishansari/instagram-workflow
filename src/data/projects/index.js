...
// import lines to maintain: drop in a new <id>.js following the stu-beta.js contract
...
for (const path in mods) {
  ...
  PROJECTS[m.meta.id] = {
    ...
    theme: m.meta.theme || null, // optional palette variant WITHIN that kit (see the kit's fyp.css)
